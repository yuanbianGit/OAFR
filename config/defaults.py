...
_C.SOLVER.PERSON_OCC_PRO = 0.5
_C.SOLVER.PERSON_m = 3
_C.SOLVER.NEAREST_K = 5
_C.SOLVER.RECOVER_METHOD = 'soft_label'
'''
hard_label
soft_label
mean
'''
_C.SOLVER.COE_LR_4MIN = 0.002
...
_C.TEST.VISUAL_DIR = ""
# 要进行可视化的query,[]的话就是全部进行,或者为list,可视化特定的query结果[19,21,30]
_C.TEST.PID_VISUAL = []
_C.TEST.VISUAL_FEAT_RECOVERY = False
_C.TEST.LOCAL = False
